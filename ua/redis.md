...
Книга «Little Redis Book» (Маленька книжка про Редіс) ліцензована Attribution-NonCommercial 3.0 Unported. Ви не повинні платити за цю книгу.
...
Redis офіційно не підтримується на операційній системі Windows, але є доступні варіанти. Ви не будете використовувати їх у виробничому середовищі, але я ніколи не стикався з жодними обмеженнями під час розробки.
